...
const BookBadgeMapping = () => {
  ...
  useEffect(() => {
    ...
    loadInitialData();
  }, [getAllBooks, getAllBadges, currentPage, pageSize, filterTerm]);
  ...
  const saveMappings = useCallback(async () => {
    ...
    setLoadingMapping(true);
    try {
      // Send badgeId with all selected bookIds in a single API call
      await assignBookBadgeMapping(selectedBadge.id, selectedBooks);
  ...
  }, [selectedBadge, selectedBooks, assignBookBadgeMapping, closeMappingModal]);
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  {badges.length} Badges • Manage badge assignments for books
                </p>
              </div>
            </div>
          </div>
