...
import { useBookBadgeManagement } from '../../../../hooks/api/useBookBadgeManagement';
...
const BookBadgeManagement = () => {
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      ...
      if (showEditModal && formData.id) {
        ...
        await updateBookBadge(formData.id, updatePayload);
        showSuccess('Book badge updated successfully!');
        closeEditModal();
      } else {
        const createPayload = {
          ...formData,
        ...
        await createBookBadge(createPayload);
        showSuccess('Book badge created successfully!');
        closeCreateModal();
      }
    } catch (err) {
      const errorMessage = err.message || 'Failed to save book badge';
      showError(errorMessage);
      setFormErrors({ submit: errorMessage });
    }
  }, [formData, showEditModal, updateBookBadge, createBookBadge, showSuccess, closeEditModal, closeCreateModal, showError, user]);
  ...
  const handleDelete = useCallback(async (badge) => {
    ...
    try {
      await deleteBookBadge(badge.id);
      showSuccess('Book badge deleted successfully!');
    } catch (err) {
      const errorMessage = err.message || 'Failed to delete book badge';
      showError(errorMessage);
    }
  }, [deleteBookBadge, showSuccess, showError]);
  ...
  const handleFilter = useCallback(() => {
    ...
    fetchBookBadges(pagination.page, pagination.pageSize, searchTerm);
  }, [searchTerm, fetchBookBadges, pagination.page, pagination.pageSize]);
  ...
  const goToPage = useCallback((page) => {
    fetchBookBadges(page, pagination.pageSize, filterTerm);
  }, [fetchBookBadges, pagination.pageSize, filterTerm]);

  if (loading && bookBadges.length === 0) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div>
        <span className="ml-3 text-gray-600">Loading book badges...</span>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Manage and organize badges for books</p>
            </div>
            <button
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{bookBadges.length}</p>
                <p className="text-xs text-gray-500 mt-1">All book badges</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-600 mt-2">
                  {bookBadges.filter(b => b.isActive).length}
                </p>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-purple-600 mt-2">
                  {bookBadges.filter(b => b.isUsedInFilter).length}
                </p>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-orange-600 mt-2">
                  {new Set(bookBadges.map(b => b.badgeKey)).size}
                </p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search book badges by name..."
                value={searchTerm}
        ...
        {bookBadges.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No book badges found</h3>
            <p className="text-gray-600 mb-6">
              {filterTerm ? 'Try adjusting your filter terms' : 'Get started by creating your first book badge'}
            </p>
            <button
              onClick={openCreateModal}
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-semibold text-gray-900">
                  {showEditModal ? 'Edit Book Badge' : 'Create New Book Badge'}
                </h2>
              </div>
              <button
...
export default BookBadgeManagement;
