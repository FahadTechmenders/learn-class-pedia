...
export const useBookCategoryManagement = () => {
  ...
  const getAllCategories = useCallback(async (pageNumber = 1, pageSize = 20, title = '') => {
    ...
    try {
      const response = await ApiService.getAllBookCategories(pageNumber, pageSize, title);
  ...
  const getCategoryById = useCallback(async (id) => {
    ...
    try {
      const response = await ApiService.getBookCategoryById(id);
  ...
  const createCategory = useCallback(async (categoryData) => {
    ...
    try {
      const response = await ApiService.createBookCategory(categoryData);
  ...
  const updateCategory = useCallback(async (id, categoryData) => {
    ...
    try {
      const response = await ApiService.updateBookCategory(id, categoryData);
  ...
  const deleteCategory = useCallback(async (id) => {
    ...
    try {
      await ApiService.deleteBookCategory(id);
      return true;
    } catch (err) {
